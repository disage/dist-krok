        ...
        return (
            <div className="sidebar">
                <nav>
                    <svg
                        ...
                        <path
                            ...
                            fill="#575C69"
                        />
                        <circle cx="56" cy="19" r="9" stroke="#575C69"
                                strokeWidth="4.5"
                                fill="transparent"/>
                    </svg>
                        ...
                        <svg
                            ...
                            <g clipPath="url(#clip0)">
                                ...
                                <path
                                    ...
                                    fill="#575C69"
                                />
                                <path d="M0 16.6667H5.33323V17.3333H0V16.6667Z"
                                      fill="#575C69"/>
                                <path d="M6 16.6667H10.3332V17.3333H6V16.6667Z"
                                      fill="#575C69"/>
                                <path
                ...
                <div className="userInfo">
                    <span
                        className="userName">{email ? email : 'undefind'}</span>
                    <span>ІПЗР-17к</span>
                    <span>4 курс</span>
                    <span className="exitAcc" onClick={this.logOut}>Выйти</span>
                </div>
            </div>
        );
    }
